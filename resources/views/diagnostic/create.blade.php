...
@section('content')
    ...
    {{Form::open(['route' => ['diagnostics.store'], 'files' => true,'id'=>"Register_Patient_Form"])}}
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group @if ($errors->has('normal_range')) has-error @endif">
            ...
            {!! Form::text('normal_range', null, ['class' => 'form-control', 'placeholder' => 'Normal Range',"autocomplete"=>"off"]) !!}
