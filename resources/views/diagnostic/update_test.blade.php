...
@section('page_title')
    Update Diagnostic Results: {{$patient->name}}
@endsection
...
@section('content')
    ...
    <form class="form-horizontal" method="POST"
          action="{{route('diagnostics.test.update',$patient->id)}}"
                ...
                <table class="table table-bordered table-hover">
                    ...
                    @foreach($tests as $test)
                        <tr>
                            ...
                            <input type="hidden" name="test_id[]" id="token" value="{{$test->id}}">


                            <td><input type="text" data-type="ProductName" name="itemName[]"
                                       id="itemName_1" class="form-control autocomplete_txt"
                                       value="{{$test->diagnostic->name}}" required readonly="readonly"
                                       autocomplete="off"></td>
                            <td>
