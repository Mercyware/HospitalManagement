<div class="modal fade " id="Bill_Patient_Modal" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="memberModalLabel">Patient Billing</h4>
            </div>
            <div class="ct">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12"
                                        ...
                                        <label>Consultation and Other Fees/Charges</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6" style="margin-left:0px;  padding-left:0px;">
                                                <div class="form-group">
                                                    {{--<input type="text" class="form-control FeeName"--}}
                                                    {{--name="FeeName[0].FeeNames"--}}
                                                    {{--placeholder="Fee Name"--}}
                                                    {{--value="Consultation Fee"/>--}}
                                                    <select name="FeeName[0].FeeNames" class="form-control FeeName">
