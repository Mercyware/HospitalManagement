...
@section('content')
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group @if ($errors->has('name')) has-error @endif">
            ...
            {!! Form::text('name', $blood->name, ['class' => 'form-control', 'placeholder' => 'Name','readonly']) !!}
        ...
        <div class="form-group @if ($errors->has('rh_factor')) has-error @endif">
            ...
            {!! Form::select('rh_factor', ['+'=>'+ (Positive)','-'=>'- (Negative)'],$blood->rh_factor,   ['class' => 'form-control','readonly']) !!}
