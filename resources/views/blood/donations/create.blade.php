...
@section('content')
    ...
    {{Form::open(['route' => ['blood.donation.store'], 'files' => true,'id'=>"Register_Patient_Forms"])}}
    ...
    <div class="col-sm-6">
        ...
        <div class="col-sm-6" style="margin-left:0px;  padding-left:0px;">
            ...
            <div class="form-group @if ($errors->has('date_last_donated')) has-error @endif">
                {!! Form::label('date_last_donated', 'Date Last Donated') !!}
                {!! Form::text('date_last_donated', $value =  \Carbon\Carbon::parse(\Carbon\Carbon::now())->format('d/m/Y'), ['class' => 'form-control DatePicker', 'placeholder' => 'Date Of Birth',   ]) !!}
                @if ($errors->has('date_last_donated')) <p
                        class="help-block">{{ $errors->first('date_last_donated') }}</p> @endif
            </div>
    ...
    <div class="col-sm-12 ">
        ...
        <input type="submit" class="btn btn-success btn-md pull-right" value="Store Donation">
