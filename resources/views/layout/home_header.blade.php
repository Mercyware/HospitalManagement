...
<head>
    ...
    <title>MedCrux Integrated Health Services : Hospital Management System</title>
...
<div class="container-fluid">
    <div class="row" style="background:green; margin-bottom: 10px" >
        <div class="col-md-12 col-sm-12">
            <div class="softwareName text-center">
                <h1>MedCrux Integrated Health Services </h1>
