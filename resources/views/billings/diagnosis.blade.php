...
@section('content')
    ...
    <form method="POST" id="search-form" class="form-inline" role="form"
          action="{{route('patient.diagnosis.billing.store')}}">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="callout-info callout"><strong> To add discount, use + for positive and - for negatives.
                ...
                <div class="dataTable_wrapper">
                    <table class="table table-bordered" id="users-table">
                        ...
                        @foreach($prices as $price)
                            <tr>
                                <td><input type="checkbox"  name="price[{{$price->id}}]"></td>
                                <td>
        ...
        <input class="btn btn-success" type="submit" value="Store Payment"/>
    </form>
