...
$(".addmore").on('click', function () {
    ...
    html += '<td>' +
        '<input type="text" name="result[]" id="result_' + i + '" class="form-control totalLinePrice" autocomplete="off"  ondrop="return false;" onpaste="return false;" >' +
        '<br/><input type="file" name="result_file[]" id="result_' + i + '" class="form-control totalLinePrice" autocomplete="off"  ondrop="return false;" onpaste="return false;" >' +
        '</td>';
    ...
    html += '<td><input type="text" name="discount[]" id="discount_' + i + '" class="form-control changesNo" autocomplete="off"  ondrop="return false;" onpaste="return false;" ></td>';
    html += '</tr>';
    $('table').append(html);
    i++;
});
...
$(document).on('focus', '.autocomplete_txt', function () {
    ...
    $(this).autocomplete({
        ...
        select: function (event, ui) {
            ...
            $('#quantity_' + id[1]).val(names['normal_range']);
