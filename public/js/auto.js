...
$(".addmore").on('click', function () {
    ...
    html += '<td><input type="number" name="days[]" id="days_' + i + '" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" ></td>';
...
$(document).on('focus', '.autocomplete_txt', function () {
    ...
    $(this).autocomplete({
        ...
        select: function (event, ui) {
            ...
            $('#itemName_' + id[1]).val(names['drugname']);
